...
title: Cligram v2
date: "2025-07-20"
summary: Using JSON-RPC over stdio to achieve bidirectional communication between Go and JavaScript.
...
previously, I built it with React. There is an amazing npm package called [ink](https://www.npmjs.com/package/ink), which is a React renderer just like react-dom for the web, react-native for mobile,
